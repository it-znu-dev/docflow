...
class PeriodsController extends Controller {
  ...
  public function accessRules() {
    return array(
        array('allow', // allow all users to perform  actions
            ...
            'roles' => array('Root','FlowPeriodsAdmin'),
        ),
  ...
  public function actionIndex() {
    $_params = Yii::app()->request->getParam('Periods',array());
  ...
  public function actionCreate() {
    ...
    if(!empty($_params)){
      ...
      if ($model->save()){
        $this->redirect(Yii::app()->CreateUrl('periods'));
      }
    }
  ...
  public function actionXupdate() {
    ...
    $model = Periods::model()->findByPk($pk);
  ...
  public function actionDelete($id=null) {
    ...
    $model = Periods::model()->findByPk($identifier);
    if ($model){
      return $model->delete();
    }
  }
