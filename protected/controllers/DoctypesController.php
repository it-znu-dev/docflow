...
class DoctypesController extends Controller {
  ...
  public function accessRules() {
    return array(
        array('allow', // allow all users to perform  actions
            ...
            'roles' => array('Root','DocTypesAdmin'),
        ),
  ...
  public function actionIndex() {
    $_params = Yii::app()->request->getParam('Doctypes',array());
  ...
  public function actionCreate() {
    ...
    if(!empty($_params)){
      ...
      if ($model->save()){
        $this->redirect(Yii::app()->CreateUrl('doctypes'));
      }
    }
  ...
  public function actionXupdate() {
    ...
    $model = Doctypes::model()->findByPk($pk);
  ...
  public function actionDelete($id=null) {
    ...
    $model = Doctypes::model()->findByPk($identifier);
    if ($model){
      return $model->delete();
    }
  }
