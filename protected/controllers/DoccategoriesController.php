...
class DoccategoriesController extends Controller {
  ...
  public function accessRules() {
    return array(
        array('allow', // allow all users to perform  actions
            ...
            'roles' => array('Root','DocCategoriesAdmin'),
        ),
  ...
  public function actionIndex() {
    $_params = Yii::app()->request->getParam('Doccategories',array());
    $model =new Doccategories('search');
  ...
  public function actionCreate() {
    ...
    if(!empty($_params)){
      ...
      if ($model->save()){
        $this->redirect(Yii::app()->CreateUrl('doccategories'));
      }
    }
  ...
  public function actionUpdate($id) {
    $_params = Yii::app()->request->getParam('Doccategories',array());
    $model = Doccategories::model()->findByPk($id); 
  ...
  public function actionXupdate() {
    ...
    $model = Doccategories::model()->findByPk($pk);
  ...
  public function actionDelete($id=null) {
    ...
    $model = Doccategories::model()->findByPk($identifier);
    if ($model){
      return $model->delete();
    }
  }
