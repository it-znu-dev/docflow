...
class EventlevelsController extends Controller {
  ...
  public function accessRules() {
    return array(
        array('allow', // allow all users to perform  actions
            ...
            'roles' => array('Root','EventLevelsAdmin'),
        ),
  ...
  public function actionIndex() {
    $_params = Yii::app()->request->getParam('Eventlevels',array());
    $model =new Eventlevels('search');
  ...
  public function actionCreate() {
    ...
    if(!empty($_params)){
      ...
      if ($model->save()){
        $this->redirect(Yii::app()->CreateUrl('eventlevels'));
      }
    }
  ...
  public function actionUpdate($id) {
    $_params = Yii::app()->request->getParam('Eventlevels',array());
    $model = Eventlevels::model()->findByPk($id); 
  ...
  public function actionXupdate() {
    ...
    $model = Eventlevels::model()->findByPk($pk);
  ...
  public function actionDelete($id=null) {
    ...
    $model = Eventlevels::model()->findByPk($identifier);
    if ($model){
      return $model->delete();
    }
  }
