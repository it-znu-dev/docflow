  ...
  <?php
    ...
    <div class="row" style="margin-left: 0px; margin-right: 0px;">
      ...
      <div class="col-xs-12 col-sm-6 form-group">
          <?php echo $form->labelEx($model,'KindName'); ?>
          <?php echo $form->textField($model,'KindName',array(
      ...
      <div class="col-xs-12 col-sm-6 form-group">
          <?php echo $form->labelEx($model,'KindStyle'); ?>
          <?php echo $form->textField($model,'KindStyle',array(
