 ...
 *
 * The followings are the available columns in table 'event_organizer':
...
class EventOrganizer extends CActiveRecord
{
  ...
  public function rules(){
    ...
    return array(
      array('EventID, DeptID, OrganizerComment', 'required'),
      array('EventID, DeptID', 'numerical', 'integerOnly'=>true),
      array('OrganizerComment', 'length', 'max'=>255),
      // The following rule is used by search().
      // @todo Please remove those attributes that should not be searched.
      array('EventID, DeptID, OrganizerComment', 'safe', 'on'=>'search'),
    );
  }
  ...
  public function attributeLabels(){
    return array(
      ...
      'DeptID' => 'ідентифікатор підрозділу організатора або -1',
      'OrganizerComment' => 'організатори текстом',
    );
  }
